                ...
                <div className="card" style={{ background: 'white', borderRadius: '12px', padding: '2rem', boxShadow: '0 4px 12px rgba(0,0,0,0.05)' }}>
                    ...
                    <div style={{ background: '#f0f9ff', borderRadius: '10px', border: '1px solid #bae6fd', padding: '1.25rem' }}>
                        ...
                        <ol style={{ margin: 0, padding: '0 0 0 1.2rem', display: 'flex', flexDirection: 'column', gap: '6px' }}>
                            ...
                            <li style={{ color: '#0369a1', fontSize: '0.85rem', lineHeight: '1.5' }}><strong>Schedule (optional)</strong> – Set a <em>Start Time</em> to begin the campaign at a specific date/time. Set an <em>End Time</em> to auto-stop it each day. If contacts remain unfinished, the campaign resumes the next day at the Start Time.</li>
